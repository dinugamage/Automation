...
public class AppiumWeb {
    ...
    public void beforeMethod() throws Exception {
    	...
    	desiredCapabilities.setCapability(MobileCapabilityType.APP_PACKAGE, "com.android.chrome");
    	desiredCapabilities.setCapability(MobileCapabilityType.APP_ACTIVITY, "com.googlr.andoif.apps.chrome.Maom");
